...
from etlCode.common.s3 import S3BucketConnector
...
class EtlSourceConfig(NamedTuple):
    ...
    src_col_end_price: column name for end price in source
...
class EtlTargetConfig(NamedTuple):
    ...
    trg_col_cl_price: column name for closing price in target
...
class ETL():
    """
    Reads the data, transforms and writes the transformed data to target
    """
